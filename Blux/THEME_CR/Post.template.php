...
function template_main()
{
	...
	if (!empty($settings['additional_options_collapsable']))
		echo '
					<div id="postAdditionalOptionsHeader">
						<img src="', $settings['images_url'], '/collapse.gif" alt="-" id="postMoreExpand" style="display: none;" /> <strong><a href="#" id="postMoreExpandLink">Attachments</a></strong>
					</div>';
	...
	echo '
				if (window.XMLHttpRequest)
				{
					...
					var x = new Array();
					var textFields = [\'subject\', ', JavaScriptEscape($context['post_box_name']), ', \'guestname\', \'email\', \'evtitle\', \'question\', \'topic\'];
					var numericFields = [
				...
				aSwapLinks: [
					{
						...
						msgExpanded: ', JavaScriptEscape('Hide Attachments'), ',
						msgCollapsed: ', JavaScriptEscape('Manage Attachments'), '
					}
				]
			});';
